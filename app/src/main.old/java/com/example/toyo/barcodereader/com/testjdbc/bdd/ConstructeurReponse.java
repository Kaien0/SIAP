...
import com.example.toyo.barcodereader.BackgroundTask;
 ...
 */
public class ConstructeurReponse extends AsyncTask<String, String, String> {
    private Context ctx = null;
    public ConstructeurReponse(Context ctx){
        this.ctx = ctx;
    }
    @Override
    ...
    protected void onPostExecute(String result) {
        Log.d("AAAAA",this.getStatus().toString());
