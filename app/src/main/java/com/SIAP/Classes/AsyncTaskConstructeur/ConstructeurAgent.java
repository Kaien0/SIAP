 ...
 */
public class ConstructeurAgent extends AsyncTask<String, String, String>{
    private Context ctx;
    public ConstructeurAgent(Context ctx){
        this.ctx = ctx;
    }
    @Override
    protected String doInBackground(String... params) {
        String result = "";
        String url_form = "http://Kaien.fr/constructeurAgent.php";
        String id = params[0];
        try {
