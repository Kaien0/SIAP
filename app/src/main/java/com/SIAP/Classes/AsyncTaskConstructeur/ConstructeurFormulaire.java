package com.SIAP.Classes.AsyncTaskConstructeur;
 ...
 */
public class ConstructeurFormulaire extends AsyncTask<String, String, String> {

    private Context ctx = null;
    public ConstructeurFormulaire(Context ctx){
        this.ctx = ctx;
    }
    @Override
    ...
    protected String doInBackground(String... params) {
        String result = "";
        String url_form = "http://Kaien.fr/constructeurFormulaire.php";
        String id = params[0];
        try {
